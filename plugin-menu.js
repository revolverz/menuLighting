...
( function ( $ ) {
    var methods = {
        init: function( options ) {
            ...
            settings.isClick && clickInit( settings );
            settings.isLightBg && $( document ).bind( 'scroll.menuLighting', onLightBg( settings ) );
            settings.isScroll && $( document ).bind( 'scroll.menuLighting', initScroll( settings ) );
        },
